...
export function getPropertyImagePath(propertyId: string): string | null {
  ...
  const imageMapping: Record<string, string> = {
    ...
    'gas_station_convenience': '/attached_assets/Gas_Station_Convenience_Store.jpg',
    'grocery_neighborhood': '/attached_assets/Neighborhood_Grocery.jpg',
    'pharmacy_building': '/attached_assets/Pharmacy_Building.jpg',
    ...
    'self_storage_facility': '/attached_assets/Self_Storage_Facility.jpg',
