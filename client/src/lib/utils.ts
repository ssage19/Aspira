...
export function getPropertyImagePath(propertyId: string): string | null {
  ...
  const imageMapping: Record<string, string> = {
    ...
    'boutique_hotel': '/attached_assets/Boutique_Hotel.jpg',
    'standalone_restaurant': '/attached_assets/Standalone_Restaurant.jpg',
    'gas_station': '/attached_assets/Gas_Station_Convenience_Store.jpg',
    'convenience_store': '/attached_assets/Gas_Station_Convenience_Store.jpg',
    'neighborhood_grocery': '/attached_assets/Neighborhood_Grocery.jpg',
    'pharmacy': '/attached_assets/Pharmacy_Building.jpg',
    'business_hotel': '/attached_assets/Business_Hotel.jpg',
    ...
    'daycare': '/attached_assets/Daycare_Center.jpg',
